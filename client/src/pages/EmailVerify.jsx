...
const EmailVerify = () => {
  ...
  const onSubmitHandler = async (e)=>{
    try {
      //will ensure after submitting form it wont reload the web 
      e.preventDefault();
      //to get otp
      const otpArray = inputRefs.current.map(e => e.value)
      //join the above array and make it singe list 
      const otp = otpArray.join('')

      //to send otp on backend , we added api call
  ...
  //after verifying user should stay on the home page and others , shouldnt go on email-verify page again , for that following function is used
